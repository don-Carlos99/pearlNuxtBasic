            ...
            <div class="row no-gutters h-100">
                <div class="col-md-6 bg-primary r-l" style="">
                    <div class="p-3 p-md-5 d-flex flex-column h-100">
                        ...
                        <div class="d-flex text-sm text-fade"><a href="index.html" class="text-white">About</a> <span
                                class="flex"></span> <a href="#" class="text-white mx-1">Terms</a> <a href="#"
                                class="text-white mx-1">Policy</a></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div id="content-body">
                        <div class="p-3 p-md-5">
                            <div>
                                ...
                                <p class="text-muted my-3">Enter your email below and we will send you instructions on
