        ...
        <div class="navbar navbar-expand-lg"><a href="index-2.html" class="navbar-brand" data-pjax-state=""><svg width="32" height="32" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><g class="loading-spin" style="transform-origin: 256px 256px"><path d="M200.043 106.067c-40.631 15.171-73.434 46.382-90.717 85.933H256l-55.957-85.933zM412.797 288A160.723 160.723 0 0 0 416 256c0-36.624-12.314-70.367-33.016-97.334L311 288h101.797zM359.973 134.395C332.007 110.461 295.694 96 256 96c-7.966 0-15.794.591-23.448 1.715L310.852 224l49.121-89.605zM99.204 224A160.65 160.65 0 0 0 96 256c0 36.639 12.324 70.394 33.041 97.366L201 224H99.204zM311.959 405.932c40.631-15.171 73.433-46.382 90.715-85.932H256l55.959 85.932zM152.046 377.621C180.009 401.545 216.314 416 256 416c7.969 0 15.799-.592 23.456-1.716L201.164 288l-49.118 89.621z"></path></g></svg> <span class="hidden-folded d-inline l-s-n-1x">Basik</span></a>
            <div class="collapse navbar-collapse order-2 order-lg-1" id="navbarToggler">
                <ul class="navbar-nav" data-nav="">
                    ...
                    <li class="nav-item"><a href="#demos" class="nav-link" data-pjax-state=""><span class="nav-text">Demo</span></a></li>
                </ul>
            </div>
            <ul class="nav navbar-menu order-1 order-lg-2">
                <li class="nav-item"><a class="nav-link no-ajax" href="docs/indexf547.html?hideAside=false">Docs</a></li>
                <li class="d-flex align-items-center"><a href="http://themeforest.net/user/flatfull" target="_blank" class="btn btn-rounded btn-sm btn-primary" data-pjax-state="">Download</a></li>
                <li class="nav-item d-lg-none"><a href="#" class="nav-link px-2" data-toggle="collapse" data-toggle-class="" data-target="#navbarToggler" data-pjax-state=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></a></li>
            </ul>
        </div>
    </header>
    <div id="main" class="layout-row flex">
        <div id="content" class="flex">
            <div class="bg-white">
                <div class="bg-white p-5">
                    <div class="col-md-8 mx-auto">
                        <div class="py-5 text-center">
                            <h1 class="text-lg font-weight-bold text-highlight">Responsive Bootstrap Web Application and Customizable Admin Template</h1>
                            <p class="text-md my-5 l-h-2x">Basik responsive bootstrap template is a useful front-end components that helps the developers build beautiful and functional web application fast and easy.</p><a href="#demos" class="btn btn-md btn-white b-a m-1">View the Demo</a>                            <a href="https://themeforest.net/item/basik-responsive-bootstrap-web-admin-template/23365964" class="btn btn-md btn-outline-primary m-1">Buy this theme</a></div>
                    </div>
                </div>
                <div class="bg-white b-b px-2 py-5">
                    <div class="col-10 col-sm-6 mx-auto">
                        <div class="browser colored no-b-b no-r-b bg-body">
                            <div class="pos-rlt">
                                <div class="pos-abt swapimg" style="background-image: url(@/assets/img/_a.png)">
                                    <div class="handler"></div>
                                </div><img src="@/assets/img/_b.png" class="w-100 no-radius" alt="White Dashboard"></div>
                        </div>
                    </div>
                </div>
                <div class="px-2 py-5 bg-dark" id="categories">
                    <div class="col-11 col-sm-9 mx-auto">
                        <h2 class="h1 text-highlight mt-5 font-weight-bold">Categories</h2>
                        <p>Basik give three categories to build web applications</p>
                        <div class="row">
                ...
                <div class="px-2 py-5 bg-body" id="features">
                    <div class="col-10 col-sm-8 mx-auto">
                        <h2 class="h1 text-highlight mt-5 font-weight-bold">Features</h2>
                        <p>Bootstrap 4 framework template</p>
                        <div class="row">
                            <div class="col-6 col-md-3 my-4"><span class="text-muted">.01</span>
                                <h5 class="my-3 text-highlight">Ajax Loading</h5>
                            ...
                            <div class="col-6 col-md-3 my-4"><span class="text-muted">.02</span>
                                <h5 class="my-3 text-highlight">Lazy load modules</h5>
                                <p class="text-muted">Load modules &amp; components on demand (lazy load) with jQuery.</p>
                            </div>
                            <div class="col-6 col-md-3 my-4"><span class="text-muted">.03</span>
                                <h5 class="my-3 text-highlight">SASS CSS</h5>
                            ...
                            <div class="col-6 col-md-3 my-4"><span class="text-muted">.04</span>
                                <h5 class="my-3 text-highlight">NPM &amp; Grunt</h5>
                                <p class="text-muted">Automate development tasks, like compiling Sass to CSS, concatenating and minifying js files; NPM manages frameworks, libraries, assets, and utilities.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="px-2 py-5 px-md-5 mt-5" id="demos">
                    <div class="col-sm-5 mx-auto text-center">
                        <h2 class="text-highlight mt-5">Templates with Dark &amp; Light colors</h2>
                        <p class="text-md my-5 l-h-2x">Basik provides two color styles for your porject. All components have dark and white style.</p>
                    </div>
        ...
        <div class="page-container">
            <div class="padding">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-8">
                            <p class="l-h-2x mb-5 text-muted">Basik is a responsive bootstrap web application and customizable admin template that helps the developers build beautiful and functional web application fast and easy. It comes with four applications and lot of useful components
                                which can help you to build CMS system, Project management and other web applications.</p>
                            <div class="row">
                ...
                <div class="py-5 text-sm text-muted">
                    <div class="row">
                        <div class="col-12 col-sm-4">© Copyright. Basik</div>
                        <div class="col-12 col-sm-8">Bootstrap 4 Web Application</div>
                    </div>
                </div>
            </div>
        </div>
