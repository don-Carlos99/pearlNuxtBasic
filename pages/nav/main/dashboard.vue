        ...
        <div class="page-content page-container" id="page-content">
            <div class="padding">
                <div class="row row-sm sr">
                    <div class="col-md-12 col-lg-8">
                        <div class="row row-sm">
                            <div class="col-md-8">
                                <div class="row row-sm">
                                    <div class="col-12">
                                        <div class="card" data-sr-id="2" style="
                        visibility: visible;
                        transform: none;
                        opacity: 1;
                      ...
                      ">
                                ...
                                <div class="row row-sm">
                                    <div class="col-6 d-flex">
                                        <div class="card flex" data-sr-id="3" style="
                        visibility: visible;
                        transform: none;
                        opacity: 1;
                        transition: none 0s ease 0s;
                      ">
                                            <div class="card-body">
                                                ...
                                                <div class="progress my-3 circle" style="height: 6px">
                                                    <div class="progress-bar circle gd-primary" data-toggle="tooltip"
                                                        title="" style="width: 65%" data-original-title="65%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 d-flex">
                                        <div class="card flex" data-sr-id="4" style="
                        visibility: visible;
                        transform: none;
                        opacity: 1;
                        transition: none 0s ease 0s;
                      ">
                                            <div class="card-body">
                                                ...
                                                <div class="progress my-3 circle" style="height: 6px">
                                                    <div class="progress-bar circle gd-warning" data-toggle="tooltip"
                                                        title="" style="width: 25%" data-original-title="25%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 d-flex">
                                <div class="card flex" data-sr-id="5" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                          ...
                          ">
                            ...
                            <div class="col-4">
                                <div class="card" data-sr-id="6" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                            ...
                            <div class="col-4">
                                <div class="card" data-sr-id="7" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                            ...
                            <div class="col-4">
                                <div class="card" data-sr-id="8" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                    ...
                    <div class="col-md-12 col-lg-4 d-flex">
                        <div class="card flex" data-sr-id="9" style="
                visibility: visible;
                transform: none;
                opacity: 1;
                transition: none 0s ease 0s;
              ">
                            <div class="card-body">
                                <div class="px-4">
                                    <div id="jqvmap-world" style="height: 200px"
                    ...
                    <div class="col-md-4 d-flex">
                        <div class="card flex" data-sr-id="10" style="
                visibility: visible;
                transform: none;
                opacity: 1;
                transition: none 0s ease 0s;
              ">
                            <div class="card-body">
                                <div class="d-flex align-items-center text-hover-success">
                                    ...
                                    <a href="#" class="text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <div class="col-md-8 d-flex">
                        <div class="card flex" data-sr-id="11" style="
                visibility: visible;
                transform: none;
                opacity: 1;
                transition: none 0s ease 0s;
              ">
                    ...
                    <div class="col-md-4">
                        <div class="row row-sm">
                            <div class="col-6">
                                <div class="card" data-sr-id="12" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                        ...
                        ">
                            ...
                            <div class="col-6">
                                <div class="card" data-sr-id="13" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                        ...
                        ">
                            ...
                            <div class="col-12">
                                <div class="card pb-3" data-sr-id="14" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                                                ...
                                                <div class="btn-group-toggle" data-toggle="buttons">
                                                    <label class="btn"><input type="radio" name="options" />
                                                        1h</label><label class="btn active"><input type="radio"
                                                            name="options" /> 1d</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="list list-row">
                                        <div class="list-item" data-id="3" data-sr-id="15" style="
                        visibility: visible;
                        transform: none;
                        opacity: 1;
                        transition: none 0s ease 0s;
                      ">
                                            <div>
                                                <label class="ui-check m-0 ui-check-rounded ui-check-md"><input
                                                        type="checkbox" name="id" value="3" /> <i></i></label>
                                            </div>
                                            <div class="flex">
                                            ...
                                            <div>
                                                <div class="item-action dropdown">
                                                    <a href="#" data-toggle="dropdown" class="text-muted"><svg
                                        ...
                                        <div class="list-item" data-id="6" data-sr-id="16" style="
                        visibility: visible;
                        transform: none;
                        opacity: 1;
                        transition: none 0s ease 0s;
                      ">
                                            <div>
                                                <label class="ui-check m-0 ui-check-rounded ui-check-md"><input
                                                        type="checkbox" name="id" value="6" /> <i></i></label>
                                            </div>
                                            <div class="flex">
                                                <a href="#" class="item-title text-color h-1x">eBay Dashboard</a>
                                                <div class="item-except text-muted text-sm h-1x">
                                                    This makes me believe there are good people in the
                                                    world still
                                                </div>
                                            </div>
                                            <div>
                                        ...
                                        <div class="list-item" data-id="20" data-sr-id="17" style="
                        visibility: visible;
                        transform: none;
                        opacity: 1;
                        transition: none 0s ease 0s;
                      ">
                                            <div>
                                                <label class="ui-check m-0 ui-check-rounded ui-check-md"><input
                                                        type="checkbox" name="id" value="20" /> <i></i></label>
                                            </div>
                                            <div class="flex">
                                                <a href="#" class="item-title text-color h-1x">Netflix hackathon ios
                                                    app</a>
                                                <div class="item-except text-muted text-sm h-1x">
                                                    Netflix hackathon creates eye tracking option for iOS
                                                    app
                                                </div>
                                            </div>
                                            <div>
                    ...
                    <div class="col-md-8">
                        <div class="card" data-sr-id="18" style="
                visibility: visible;
                transform: none;
                opacity: 1;
                transition: none 0s ease 0s;
              ">
                                    ...
                                    <div>
                                        <div class="btn-group btn-group-toggle" id="btn_l_4" data-toggle="buttons">
                                            <label class="btn active"><input type="radio" name="options" />
                                                Month</label><label class="btn"><input type="radio" name="options" />
                                                Week</label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-7">
                        <div class="card" data-sr-id="19" style="
                visibility: visible;
                transform: none;
                opacity: 1;
                transition: none 0s ease 0s;
              ">
                                ...
                                <tbody>
                                    <tr class="" data-id="8">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Egestas"><img
                                                        src="@/assets/img/a3.jpg" alt="." /> </a><a href="#"
                                                    class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Est"><img
                                                        src="@/assets/img/a9.jpg" alt="." /></a>
                                            </div>
                                        </td>
                                        <td class="flex">
                                            <a href="page.invoice.detail.html" class="item-company ajax h-1x"
                                                data-pjax-state="">Jet</a>
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    ...
                                                    class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Mauris"><img
                                                        src="@/assets/img/a4.jpg" alt="." /> </a><a href="#"
                                                    class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Semper"><img
                                                        src="@/assets/img/a13.jpg" alt="." /></a>
                                            </div>
                                        </td>
                                        <td class="flex">
                                            <a href="page.invoice.detail.html" class="item-company ajax h-1x"
                                                data-pjax-state="">Samsum Inc.</a>
                                            <div class="item-mail text-muted h-1x d-none d-sm-block">
                                    ...
                                    <tr class="" data-id="7">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Sollicitudin"><img
                                                        src="@/assets/img/a6.jpg" alt="." /> </a><a href="#"
                                                    class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Nisl"><img
                                                        src="@/assets/img/a12.jpg" alt="." /></a>
                                            </div>
                                        </td>
                                        <td class="flex">
                                            <a href="page.invoice.detail.html" class="item-company ajax h-1x"
                                                data-pjax-state="">Lostcorp</a>
                                            <div class="item-mail text-muted h-1x d-none d-sm-block">
                                    ...
                                    <tr class="" data-id="20">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Maecenas"><img
                                                        src="@/assets/img/a13.jpg" alt="." /> </a><a href="#"
                                                    class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Elit"><img
                                                        src="@/assets/img/a11.jpg" alt="." /> </a><a href="#"
                                                    class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Ultrices"><img
                                                        src="@/assets/img/a7.jpg" alt="." /></a>
                                            </div>
                                        </td>
                                        <td class="flex">
                                            <a href="page.invoice.detail.html" class="item-company ajax h-1x"
                                                data-pjax-state="">Netflix</a>
                                            <div class="item-mail text-muted h-1x d-none d-sm-block">
                                    ...
                                    <tr class="" data-id="2">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title=""
                                                    data-pjax-state="" data-original-title="Et,"><img
                                                        src="@/assets/img/a3.jpg" alt="." /></a>
                                            </div>
                                        </td>
                                        <td class="flex">
                                            <a href="page.invoice.detail.html" class="item-company ajax h-1x"
                                                data-pjax-state="">Microsoft</a>
                                            <div class="item-mail text-muted h-1x d-none d-sm-block">
                    ...
                    <div class="col-md-5 d-flex">
                        <div class="card flex" data-sr-id="20" style="
                visibility: visible;
                transform: none;
                opacity: 1;
                transition: none 0s ease 0s;
              ">
                            <div class="p-3-4">
                                <div class="d-flex">
                                    ...
                                    <span class="flex"></span>
                                    <div>
                                        <a href="#" class="p-1 text-muted"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="list list-row">
                                <div class="list-item" data-id="1" data-sr-id="21" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                                ...
                                <div class="list-item" data-id="3" data-sr-id="22" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                                ...
                                <div class="list-item" data-id="14" data-sr-id="23" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                                ...
                                <div class="list-item" data-id="20" data-sr-id="24" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                                ...
                                <div class="list-item" data-id="12" data-sr-id="25" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                                ...
                                <div class="list-item" data-id="17" data-sr-id="26" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
                  ">
                                ...
                                <div class="list-item" data-id="17" data-sr-id="27" style="
                    visibility: visible;
                    transform: none;
                    opacity: 1;
                    transition: none 0s ease 0s;
